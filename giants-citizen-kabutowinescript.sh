...
export WINEPREFIX="$SCRIPTDIR/giants-citizen-kabuto/.wine"
...
/usr/bin/wine reg add "HKCU\\Software\\PlanetMoon\\Giants" /v Renderer /d gg_null.dll /f >/dev/null
